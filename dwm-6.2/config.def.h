...
static const char *brupcmd[] = { "/usr/bin/brightnessctl", "set", "25%+", NULL };
static const char *brdowncmd[] = { "/usr/bin/brightnessctl", "set","25%-", NULL };
...
static const char col_cyan[]        = "#3c4657";
